...
//     try {
//       const { batchEnrollAllFaces } = await import('@/lib/face-enrollment');
      
//       // Run batch enrollment
//       const result = await batchEnrollAllFaces();
...
//             <h3 className="font-semibold text-gray-800 mb-4">Enrollment Statistics</h3>
...
//                 <li>• Similar to NBIS fingerprint matching technology</li>
...
//         <div className="bg-white rounded-xl shadow-lg p-6 mb-6">
//           <button
//             onClick={stats ? handleBatchEnroll : loadStats}
...
//                 Enrolling faces... {progress.current > 0 && `${progress.current}/${progress.total}`}
//               </span>
//             ) : stats ? (
...
//                     <p className="text-sm text-gray-600">Successfully Enrolled</p>
//                   </div>
...
//             {!results.success && (
//               <p className="text-red-700">{results.error || 'An error occurred during enrollment'}</p>
//             )}
//           </div>
//         )}
...
//             <p>• <strong>Algorithm:</strong> face-api.js with TensorFlow.js</p>
//             <p>• <strong>Descriptor:</strong> 128-dimensional face embedding</p>
//             <p>• <strong>Matching:</strong> Euclidean distance (threshold: 0.6)</p>
//             <p>• <strong>Storage:</strong> Appwrite database (faceDescriptor field)</p>
//             <p>• <strong>Models:</strong> TinyFaceDetector + FaceRecognitionNet</p>
//             <p>• <strong>Privacy:</strong> All processing in-browser, no external APIs</p>
//           </div>
//         </div>
//       </div>
//     </div>
