...
//             <h1 className=" font-bold text-gray-800 mb-2">FEDERAL POLYTECHNIC ILARO</h1>
//             <h3 className=" font-semibold text-gray-700">COURSE REGISTRATION FORM</h3>
...
//                   alt="Student"
//                   className="w-30 h-30 rounded-lg border-4 border-gray-300 object-cover mx-auto"
//                 />
//               ) : (
//                 <div className="w-30 h-30 rounded-lg border-4 border-gray-300 bg-gray-200 flex items-center justify-center mx-auto">
  ...
  <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
    <div className="bg-white rounded-lg shadow-2xl max-w-5xl w-full max-h-[90vh] overflow-auto">
      ...
      <div className="printable-area p-6">
        ...
        {/* Student Info Section - Row Layout */}
