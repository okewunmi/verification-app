...
//   // face-recognition-browser.js - UPDATE extractDescriptorFromElement method
...
//     // Strategy 1: Try with SSD MobileNet (default) - lower threshold
...
//     // Strategy 2: If failed, try TinyFaceDetector with larger input size
//     if (!detection) {
//       console.log('⚠️ SSD failed, trying TinyFaceDetector...');
//       detection = await faceapi
//         .detectSingleFace(imageElement, new faceapi.TinyFaceDetectorOptions({
//           inputSize: 608,  // Larger size for better detection
//           scoreThreshold: 0.3
//         }))
//         .withFaceLandmarks()
//         .withFaceDescriptor();
...
//     // Strategy 3: If still failed, try MTCNN (if you have the models)
//     if (!detection) {
//       console.log('⚠️ TinyFace failed, trying MTCNN...');
//       detection = await faceapi
//         .detectSingleFace(imageElement, new faceapi.MtcnnOptions({
//           minFaceSize: 20,
//           scaleFactor: 0.709
//         }))
//         .withFaceLandmarks()
...
//       return {
//         success: false,
//         message: 'No face detected in image (tried all detection models)'
//       };
//     }
...
//     await Promise.all([
//       faceapi.nets.ssdMobilenetv1.loadFromUri(this.modelPath),
//       faceapi.nets.tinyFaceDetector.loadFromUri(this.modelPath),  // ADD THIS
//       faceapi.nets.faceLandmark68Net.loadFromUri(this.modelPath),
//       faceapi.nets.faceRecognitionNet.loadFromUri(this.modelPath),
//     ]);
