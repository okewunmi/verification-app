...
const resend = new Resend('re_W5tcJ8Jt_7z5FsTY4Rkr3QAurB1EiKhiB vbo');
...
export const sendWelcomeEmail = async (studentData, matricNumber, defaultPassword) => {
  try {
    ...
    if (!"re_W5tcJ8Jt_7z5FsTY4Rkr3QAurB1EiKhiB vbo") {
    ...
    const { data, error } = await resend.emails.send({
      from: 'FTP Attendance <onboarding@resend.dev>', // Use this for testing
            ...
            <div class="content">
              ...
              <div class="credentials">
                ...
                <p style="margin-top: 15px; font-size: 14px;">
                  <strong>Portal URL:</strong> <a href="${process.env.NEXT_PUBLIC_APP_URL || 'http://localhost:3000'}/student-login">Click here to login</a>
                </p>
              </div>
