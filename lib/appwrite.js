 ...
 * Called during student enrollment
 */
...
/**
 * Verify fingerprint and find matching student
 * Used for: Verification page, Attendance marking
 */
// export const verifyStudentFingerprint = async (capturedTemplate) => {
//   try {
//     console.log('🔍 Searching for matching fingerprint...');
...
//     // Search through each student's fingerprints
...
//         try {
//           const compareResult = await fingerprintScanner.compare(
//             capturedTemplate,
//             finger.template
//           );

//           // Match threshold: confidence >= 70%
//           if (compareResult.matched && compareResult.confidence >= 70) {
//             console.log(`✅ MATCH FOUND! ${finger.name} finger - ${compareResult.confidence}%`);
...
//               matchTime: new Date().toLocaleTimeString(),
//               fingerUsed: finger.name
//             };
//           }

//         } catch (error) {
//           console.error(`❌ Error comparing with ${finger.name}:`, error);
//           continue;
//         }
//       }
//     }
...
// ========================================
// ADD TO lib/appwrite.js - WebAuthn Fingerprint Functions
// REPLACE the DigitalPersona functions with these
// ========================================
...
// Replace in your lib/appwrite.js file
// ========================================
...
/**
 * Create or Update Face++ Faceset with all registered students
 */
